...
struct PGComponent1: View {
    ...
    private func getFileName(_ idx: Int) -> String {
        let titles = ["RadioExample", "RadioStructure", "RadioStore", "Radio", "RadioItem", "RadioItemModifier"]
        return titles.indices.contains(idx) ? titles[idx] : ""
    }
}

struct PGComponent1_Previews: PreviewProvider {
